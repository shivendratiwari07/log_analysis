...
def analyze_logs_with_openai(log_filename):
    print(f"Starting analysis of log file: {log_filename}")
...
def analyze_and_upload(log_filename, blob_service_client, container_name, account_name, account_key):
...
def main(run_id_file):
    ...
    for step in failed_steps:
        ...
        analyze_and_upload(log_filename, blob_service_client, container_name, account_name, account_key)
